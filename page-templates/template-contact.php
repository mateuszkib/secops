    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center bg-white text-dark contact__form contact__who-bg">
            ...
            <div class="col-12 col-sm-12 col-md-6 text-center">
                ...
                <p class="mt-5">Dołącz do nas! <span class="text-success font-weight-bold">hello@secopspolska.pl</span> </p>
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-4 mt-5">
                        ...
                        <p class="font-weight-bold">kontakt@secops.pl</p>
                    </div>
                    <div class="col-12 col-xl-4 mt-5">
                        ...
                        <p class="font-weight-bold ml-3">+48 810 694 835</p>
                    </div>
                </div>
            </div>
        </div>
