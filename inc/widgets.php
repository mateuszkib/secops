    ...
    function understrap_widgets_init()
    {
        ...
        register_sidebar(
            array(
                ...
                'id'            => 'footer-1',
                'description'   => __('First column footer.', 'understrap'),
        ...
        register_sidebar(
            array(
                ...
                'id'            => 'footer-2',
                'description'   => __('Second column footer.', 'understrap'),
                'before_widget' => '<div id="%1$s" class="widget %2$s">',
                'after_widget'  => '</div>',
                'before_title'  => '<h2 class="widget-title">',
                'after_title'   => '</h2>',
        ...
        register_sidebar(
            array(
                ...
                'id'            => 'footer-3',
                'description'   => __('Third column footer.', 'understrap'),
                'before_widget' => '<div id="%1$s" class="widget %2$s">',
                'after_widget'  => '</div>',
                'before_title'  => '<h2 class="widget-title">',
                'after_title'   => '</h2>',
        ...
        register_sidebar(
            array(
                ...
                'id'            => 'footer-4',
                'description'   => __('Four column footer.', 'understrap'),
                'before_widget' => '<div id="%1$s" class="widget %2$s">',
                'after_widget'  => '</div>',
                'before_title'  => '<h2 class="widget-title">',
                'after_title'   => '</h2>',
        ...
        register_sidebar(
            array(
                'name'          => __('Footer Five', 'understrap'),
                'id'            => 'footer-5',
                'description'   => __('Five column footer.', 'understrap'),
                'before_widget' => '<div id="%1$s" class="widget %2$s">',
                'after_widget'  => '</div>',
                'before_title'  => '<h2 class="widget-title">',
                'after_title'   => '</h2>',
